...
export default function PartnershipCard({
  ...
  return (
    <div className='relative overflow-hidden w-full md:max-w-[564px] bg-dynamic hover:bg-accent/5 transition-all duration-300 ease-in-out rounded-[1.75rem] flex flex-shrink-0'>
